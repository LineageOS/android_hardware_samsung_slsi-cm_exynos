...
class ExynosOverlayDisplay : public ExynosDisplay {
    ...
    protected:
        ...
        void configureHandle(private_handle_t *handle, hwc_frect_t &sourceCrop,
                hwc_rect_t &displayFrame, int32_t blending, int32_t planeAlpha, int fence_fd, 
#ifdef DECON_FB
                decon_win_config &cfg);
#else
                s3c_fb_win_config &cfg);
        ...
        int postGscOtf(hwc_layer_1_t &layer, 
#ifdef DECON_FB
        ...
        virtual int postGscM2M(hwc_layer_1_t &layer, 
#ifdef DECON_FB
                struct decon_win_config *config, 
#else
                struct s3c_fb_win_config *config,
        ...
        virtual void configureOverlay(hwc_layer_1_t *layer, 
#ifdef DECON_FB
                decon_win_config &cfg);
#else
                s3c_win_config &cfg);

...
const size_t WIN_STATE_BUFFER = SOC_WIN_STATE_BUFFER;
const size_t WIN_STATE_COLOR = SOC_WIN_STATE_COLOR;
const size_t BLENDING_MAX = SOC_BLENDING_MAX;
const size_t PIXEL_FORMAT_MAX = SOC_PIXEL_FORMAT_MAX;
